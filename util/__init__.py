...
def train_model(model, trainloader, testloader, epochs=10, lr=0.001, device="cuda", save_path="data/resnet18_cifar10.pth"):
    model.to(device)
...
def triton_test(model, save_path="result/accuracy.txt"):
